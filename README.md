...
Repository that contains solutions to the exercises for the PPJ (Foundations of Java Programming) Java practical
classes, taught by Le Lan Truong during studies on [PJAIT](https://www.pja.edu.pl/en/).
